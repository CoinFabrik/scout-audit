...
use crate::{
    scout::{core::project_info::Project, finding::Finding as JsonFinding},
    util::{detectors_info::LintStore, json::json_to_string},
};
...
fn create_summary(
    ...
    let table = crate::scout::output::table::construct_table(json_findings, crates, detector_info);
