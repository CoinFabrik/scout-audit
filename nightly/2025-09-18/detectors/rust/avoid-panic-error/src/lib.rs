...
pub static AVOID_PANIC_ERROR_INFO: LintInfo = LintInfo {
    ...
    help: "https://coinfabrik.github.io/scout-audit/docs/detectors/rust/avoid-panic-error",
...
impl AvoidPanicError {
    fn check_function(&self, cx: &EarlyContext, output: &FnRetTy, body: &Option<Box<Block>>) {
