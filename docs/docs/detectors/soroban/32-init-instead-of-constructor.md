...
- Severity: `Low`
- Detector: [`init-instead-of-constructor`](https://github.com/CoinFabrik/scout-audit/tree/main/nightly/2025-09-18/detectors/soroban/init-instead-of-constructor)
